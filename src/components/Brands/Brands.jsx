...
export default function Brands() {
 ...
 const [showModal, setShowModal] = useState(false)
  ...
  return <>
   <Helmet><title>Brabds</title></Helmet>
    <div className="bg-[url('/src/assets/light-patten.svg')] bg-center flex-1 mt-16">
      <main className="container px-4 mx-auto overflow-hidden">
        <section className="px-2 py-12">
          ...
          {data?.data.data.map((brands) =><div onClick={() => onClickHandler(brands)} key={brands._id} className="boxshad group rounded-xl p-4 cursor-pointer" >
